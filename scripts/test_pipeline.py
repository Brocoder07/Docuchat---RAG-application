...
Senior Engineer Principle: Automated testing with clear reporting.
"""
import sys
import os
import logging
...
class PipelineTester:
    """Comprehensive pipeline testing with multiple scenarios."""
    ...
    def test_initialization(self) -> bool:
        ...
        try:
            ...
            checks = [
                ...
                status["vector_store"]["initialized"] == True,
                status["llm_service"]["initialized"] == True
            ]
            ...
            if all(checks):
                ...
                logging.error("Some components failed to initialize")
                return False
    ...
    def test_document_processing(self) -> bool:
        ...
        try:
            ...
            # Process document
            result = rag_pipeline.process_document(test_file, "test_document.txt")
    ...
    def test_query_processing(self) -> bool:
        """Test query processing with various question types."""
        test_queries = [
        ...
        for query in test_queries:
            try:
                ...
                if result["success"] and result["answer"]:
                    logging.info(f"✅ Query '{query}' - Answer generated ({len(result['sources'])} sources)")
                    passed_queries += 1
                else:
    ...
    def test_error_handling(self) -> bool:
        ...
        for invalid_input, description in invalid_scenarios:
            try:
                result = rag_pipeline.query(invalid_input)
    ...
    def test_performance(self) -> bool:
        ...
        # Performance criteria: average under 5 seconds, max under 10 seconds
